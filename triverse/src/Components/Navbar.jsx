...
const Navbar = () => {
  ...
  let class1 =
    'flex  gap-6 items-center justify-center text-center text-2xl flex-col  duration-500';
  let class2 =
    'flex  gap-8 items-center justify-center text-center text-4xl flex-col hidden duration-500 ';
    ...
    <>
      ...
      <div className="duration-500 text-center text-sm p-4 md:px-12 bg-black background-blur-xl text-purple-800 font-bold block md:hidden">
        <button onClick={() => setMobile(!Mobile)}>
          {Mobile ? (
            <ImCross className="text-2xl text-yellow-500 mb-6" />
          ) : (
        ...
        <ul className={Mobile ? class1 : class2}>
          <button
            ...
            key="home"
            className="hover:text-yellow-500 transition duration-300 cursor-pointer mt-2"
          >
            <Link to="/">Home</Link>
          </button>
